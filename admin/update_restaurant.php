...
if (isset($_POST['submit'])) {
    ...
    if (empty($_POST['c_name']) || empty($_POST['res_name']) || $_POST['email'] == '' || $_POST['phone'] == '' || $_POST['url'] == '' || $_POST['o_hr'] == '' || $_POST['c_hr'] == '' || $_POST['o_days'] == '' || $_POST['address'] == '') {
        ...
        $fname = $_FILES['file']['name']; // Lấy tên file gốc
        ...
        $extension = strtolower(end($extension)); // Lấy phần mở rộng và chuyển thành chữ thường
        $fnew = uniqid() . '.' . $extension; // Tạo tên file mới bằng mã duy nhất + phần mở rộng
        $store = "Res_img/" . basename($fnew); // Đường dẫn lưu trữ file
        //? Check file
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
            if ($fsize >= 1000000) { // Kiểm tra kích thước file (1MB = 1000000 bytes)
                ...
                //? Update info nhà hàng trong bảng restaurant dựa trên rs_id từ tham số GET
